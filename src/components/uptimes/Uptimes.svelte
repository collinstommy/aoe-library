...
<main class="flex flex-col flex-1 w-full container">
	<div class="filters pb-8">
		<div id="options" class="flex flex-col md:flex-row items-center md:items-baseline">
			<div class="flex">
		...
		<div id="civ-dropdown" class="my-6 flex flex-col md:items-start items-center">
			<label for="civs" class="font-bold pb-2">Civ</label>
			...
			<div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
				<div class="shadow border-b border-gray-200 sm:rounded-lg">
					<table class="min-w-full divide-y divide-gray-200">
						<thead>
							<tr class="bg-blue-800 text-gray-100 uppercase text-sm leading-normal dark:bg-gray-700">
